    ...
    <Teleport to="body">
        ...
        >
            <div class="mv-tag-head" @mousedown="onDragStart">
                ...
                <span class="mv-tag-title">DICOM タグ</span>
                ...
                <v-btn variant="text" size="x-small" icon @click="onClose" @mousedown.stop>
                    ...
                    <v-tooltip activator="parent" location="bottom">DICOM タグビューアを閉じる</v-tooltip>
                </v-btn>
            </div>
            ...
            <div class="mv-tag-controls" @mousedown.stop>
                <v-text-field
                    v-model="filterText"
                    placeholder="タグをフィルタ...（スペース=AND, | = OR）"
                    density="compact"
                    hide-details
                    variant="outlined"
                ...
                <v-btn variant="text" size="x-small" @click="fontMinus">
                    ...
                    <v-tooltip activator="parent" location="bottom">フォントを小さく</v-tooltip>
                </v-btn>
                <v-btn variant="text" size="x-small" @click="fontPlus">
                    <v-icon icon="mdi-format-font-size-increase" size="small" />
                    <v-tooltip activator="parent" location="bottom">フォントを大きく</v-tooltip>
                </v-btn>
                <v-btn variant="text" size="x-small" @click="onCopy">
                    <v-icon icon="mdi-content-copy" size="small" />
                    <v-tooltip activator="parent" location="bottom">フィルタ結果をコピー</v-tooltip>
                </v-btn>
                <v-btn variant="text" size="x-small" @click="onDownload">
                    <v-icon icon="mdi-download" size="small" />
                    <v-tooltip activator="parent" location="bottom">.txt としてダウンロード</v-tooltip>
                </v-btn>
            </div>

            <div class="mv-tag-output-wrap" @mousedown.stop>
                <pre class="mv-tag-output" :style="{ fontSize: fontSize + 'px' }">{{ filteredText || '(タグがありません)' }}</pre>
            </div>
